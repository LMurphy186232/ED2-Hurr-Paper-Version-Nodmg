...
subroutine init_pft_resp_params()
   ...
   !---------------------------------------------------------------------------------------!
    ...
    !                                , is_tropical(:) ) LEM - hardcoding better
    storage_turnover_rate(:) = 0.0
   !---------------------------------------------------------------------------------------!
...
subroutine init_pft_phen_params()
   ...
   !---------------------------------------------------------------------------------------!
   !storage_reflush_times(:) = merge(2.0,0.0,phenology(:) == 5) LEM - hardcoding better
   storage_reflush_times(:) = 1.0
...
subroutine init_derived_params_after_xml()
   ...
   dark_respiration_factor(18) = 0.01
   !---------------------------------------------------------------------------------------!
